...
import { TrolleyIcon, PackageIcon, HeartIcon } from "@sanity/icons"; // ❤️ icon cho wishlist
import useStore from "@/store/store"; // Đổi tên import theo store mới
    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-white px-4 py-4 shadow">
      <div className="flex w-full items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none">
          ...
          <Link
            href="/wishlist"
            className="flex-1 relative flex justify-center sm:justify-start sm:flex-none items-center space-x-2 bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-4 rounded"
          >
